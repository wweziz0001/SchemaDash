...
const getDevelopmentDescription = ({
    ...
    if (activeMode === 'development') {
        return 'This is the editable head of the diagram. Saves, restores, version actions, live-sync events, and 5 minute checkpoints feed the changelog timeline without turning it into a Versions clone.';
    }
                ...
                <div className="space-y-4 pb-2">
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-4">
                            <div className="space-y-2">
                                ...
                                <p className="max-w-xl text-sm leading-6 text-muted-foreground">
                                    ...
                                    Development activity such as saves, version
                                    actions, live sync, revert flows, and 5
                                    minute checkpoints. Versions stay separate
                                    as intentional named milestones.
                                </p>
                            </div>
                    ...
                    {entries.length === 0 ? (
                        <EmptyState
                            ...
                            description="Save the Development diagram, create a version, link a live database, or keep working long enough for the first 5 minute checkpoint to be captured."
                            className="mt-8"
                        />
                    ) : (
