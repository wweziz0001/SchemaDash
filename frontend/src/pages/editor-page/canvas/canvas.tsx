...
import { CompareSummaryChip } from './workflow/compare-summary-chip';
            ...
            >
                ...
                >
                                            ...
                                            <span>
                                                <Button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        snapToGridEnabled ||
                                                            shiftPressed
                                                            ? 'bg-teal-600 text-white hover:bg-teal-500 dark:hover:bg-teal-700 hover:text-white'
                                                            : ''
                                                    )}
                                                    onClick={() =>
                    ...
                    {!isDesktop && !readonly ? (
                        ...
                        >
                            <Button
                                className="size-11 bg-teal-600 p-2 hover:bg-teal-500"
