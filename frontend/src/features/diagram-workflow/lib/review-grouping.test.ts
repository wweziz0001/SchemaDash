...
import { buildReviewGrouping } from './review-grouping';
...
describe('buildReviewGrouping', () => {
    it('groups compare changes and supplemental plan details for review surfaces', () => {
        ...
        expect(
            review.sections.find((section) => section.key === 'tables')
        ).toEqual(
        ...
        expect(
            review.sections.find((section) => section.key === 'fields')
        ).toEqual(
            expect.objectContaining({
                totalCount: 2,
            })
        ...
        expect(
            review.supplementalSections.find(
