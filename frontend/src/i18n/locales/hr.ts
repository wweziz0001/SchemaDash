    ...
    translation: {
        ...
        export_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'Nešto je pošlo po zlu. Trebate pomoć? support@schemadash.io',
            },
        },
        ...
        import_diagram_dialog: {
            ...
            error: {
                ...
                description:
                    'JSON dijagrama je nevažeći. Molimo provjerite JSON i pokušajte ponovno. Trebate pomoć? support@schemadash.io',
            },
        },
